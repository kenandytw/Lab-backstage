...
<header id="topnav">
    <div class="topbar-main">
        <div class="container">
            ...
            <!-- Logo container-->
            <div class="logo">
                <a href="index.html" class="logo"><span style="color: #FC6E52;">SUPERISE LAB</span> </a>
            </div>
            <!-- End Logo container-->
            ...
            <div class="menu-extras">
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle waves-effect waves-light profile" data-toggle="dropdown" aria-expanded="true"><img src="backstage/images/users/avatar-1.jpg" alt="user-img" class="img-circle"> </a>
